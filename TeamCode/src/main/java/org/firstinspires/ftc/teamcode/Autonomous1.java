...
/*
      ...
      */
      ...
      //  drag = new pickUpState(.5,.5, servoDrag,1000);
        first = new timeState(4, .1, motors, "forward");
        sec = new timeState(400, .6, motors, "backward");
        prior = new timeState(10,0,motors,"forward");
     //   drag3 = new pickUpState (0,1, servoDrag, 1000);
     //   drag.setNextState(first);
     //   first.setNextState(drag3);
      //  drag3.setNextState(sec);
        sec.setNextState(null);

    }
    @Override
    public void start(){

       machine = new StateMachine(sec);
