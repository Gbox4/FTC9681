...
public class clampDriveState implements StateMachine.State {
    ...
    public clampDriveState(double target, double speed,  ArrayList<DcMotor> motor, String movement, double power, double power2, ArrayList<CRServo> CRServos) {
